# -*- coding: utf-8 -*-
"""
Created on Mon Jul 13 09:25:27 2020
...
# Column 2 = input (u)
# Column 3 = output (yp)
data = np.loadtxt('data25uM.txt',delimiter=',')
# u0 = data[0,1]
# yp0 = data[0,1]
# t = data[:,0].T - data[0,0]
t = data[:,0]
...
# plt.figure(1)
# plt.subplot(2,1,1)
plt.plot(t,yp,'ko',linewidth=2,label='Trememt Data')
plt.plot(t,ym1,'b-',linewidth=2,label='Initial Guess')
plt.plot(t,ym2,'r--',linewidth=3,label='Optimized Model')
plt.ylabel('Number of Cells')
plt.xlabel('Day')
plt.title('Best Fit Model - Mendelsohn')
plt.legend(loc='best')
#plt.subplot(2,1,2)
